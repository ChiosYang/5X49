...
SCHEMA_PATH = Path(__file__).resolve().parents[1] / "schema" / "durable_workflows_v3.sql"
...
MIGRATION = Migration(
    version=3,
    name="durable_workflows",
    checksum_material=f"fresh-canonical-v3:workflow-ddl:{SCHEMA_SHA256}",
    upgrade=upgrade,
)
