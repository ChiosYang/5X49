...
runtime deduplication, rejected-state protection, and legacy transition exist
in version 10. Quality evaluation remains pending; none of these are Gate A
...
- Slice 4 is complete, but Slice 5 and the overall Feature are blocked until a
  ...
  passed.
- The nine migration fixtures and generated runtime fixtures now extend through schema v10,
