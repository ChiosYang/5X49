...
export const API = {
  ...
  libraryOrganizationCandidates: () => `${API_BASE_URL}/library/organization/candidates`,
  libraryOrganizationPreview: () => `${API_BASE_URL}/library/organization/preview`,
  libraryOrganizationConfirm: () => `${API_BASE_URL}/library/organization/confirm`,
