...
export default async function MovieDetailView({ movie }: { movie: MovieDetail }) {
    ...
    <MovieArtworkProvider initialMovie={movie}>
      <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black">
        ...
        <div className="relative h-screen w-full overflow-hidden">
          <MovieArtworkBackdrop title={movie.title} />
        ...
        <div className="border-t border-neutral-800 grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-neutral-800 bg-black text-neutral-300">
          ...
          <MovieRefreshButton movieId={movie.id} />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 p-8 md:p-16 border-b border-neutral-800">
          ...
          <div className="lg:col-span-2">
            ...
            <MovieArtworkPoster title={movie.title} />
          </div>
        </div>
        ...
        <MovieAnalysisSection movieId={movie.id} initialMovie={movie} />
      </div>
    </MovieArtworkProvider>
  );
}
